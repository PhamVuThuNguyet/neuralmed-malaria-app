...
export default function ResultTabs(props) {
  return (
    <Tabs>
      ...
      {/* AI */}
      <TabPanel>
        <p className={styles["res-label"]}>Description</p>
        <div className={[styles["res-desc"], "mb-5"].join(" ")}>
          {/* TODO: replace with value */}
          <p>
            <span className={styles["span-red"]}>1(s)</span> Infected red blood
            cell found
          </p>
        </div>
        <p className={styles["res-label"]}>Conclusion</p>
        <div
          className={[
            styles["res-desc"],
            "flex",
        ...
        >
          <p>
            <span className={styles["span-yellow"]}>Risk of infection</span>
          </p>
          {/* TODO: replace with value */}
          <p>
        ...
        <div className={[styles["res-desc"], "mb-5", "max-w-2xl"].join(" ")}>
          <p>
            <span className={styles["span-green"]}>
              Rate the AI's suggestion for this scan
            </span>
          </p>
          <div
            className={[
